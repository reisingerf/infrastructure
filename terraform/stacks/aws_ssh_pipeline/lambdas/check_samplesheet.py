...
def lambda_handler(event, context):
    ...
    if event.get('runfolder'):
        ...
        print("Handling samplesheet check for {}".format(runfolder))
    else:
    ...
    if success:
        ...
        #                                        title="Start samplesheet check",
        #                                        message="Successfully started samplesheet check.")
    else:
        print("Failed to execute remote command.")
        # aws_pipeline_commons.call_slack_lambda(function_name=slack_lamdba_function_name,
        #                                        topic="Run: {}".format(runfolder),
        #                                        title="Start samplesheet check",
        #                                        message="Failed to start samplesheet check.")
